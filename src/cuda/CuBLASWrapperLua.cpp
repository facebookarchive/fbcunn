...
int matmult(lua_State* L, bool asComplex = false) {
  ...
  CHECK_EQ(THCudaTensor_nDimension(state, thA), THCudaTensor_nDimension(state, thB));
  CHECK_EQ(THCudaTensor_nDimension(state, thC), THCudaTensor_nDimension(state, thB));
